                ...
                <React.Fragment key={offer.title}>
                  ...
                  {isActive && (
                    <div className="block lg:hidden w-full bg-white p-6 rounded-[20px] border border-gray-100 shadow-[0_10px_30px_rgba(0,0,0,0.04)] text-left">
                      ...
                      <h3 className="font-[Georgia,serif] font-bold text-xl text-gray-900 mb-4 leading-tight">
                        {offer.title}
                      </h3>
                      
                      <div className="font-['Segoe_UI',sans-serif] font-normal text-[15px] leading-relaxed text-gray-600">
