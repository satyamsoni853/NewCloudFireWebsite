          ...
          {sections.map((section, index) => (
            ...
            >
              ...
              <div className="w-full lg:w-1/2 text-center lg:text-left">
                ...
                <p className="text-gray-500 font-['Segoe_UI',sans-serif] font-normal text-[18px] leading-[24px] mb-8 lg:mb-10">{section.subtitle}</p>
                  ...
                  <div className="mb-10">
                    ...
                    <div className="grid grid-cols-2 gap-x-4 lg:gap-x-8 gap-y-3">
                      {section.platforms.map((platform, i) => (
                        <div key={i} className="flex items-center justify-center lg:justify-start gap-4 text-[#555] font-['Segoe_UI',sans-serif] font-normal text-[18px] leading-[28px]">
                ...
                <div>
                  ...
                  <ul className="space-y-4">
                    {section.capabilities.map((cap, i) => (
                      <li key={i} className="flex items-start justify-center lg:justify-start gap-4 text-[#555] font-['Segoe_UI',sans-serif] font-normal text-[18px] leading-[28px]">
